...
CREATE
	TRIGGER IDN_OAUTH2_ACCESS_TOKEN_SYNC_INSERT_TRIGR BEFORE INSERT
		ON
...
CREATE
	TRIGGER IDN_OAUTH2_ACCESS_TOKEN_SYNC_UPDATE_TRIGR BEFORE UPDATE
		ON
		IDN_OAUTH2_ACCESS_TOKEN FOR EACH ROW BEGIN INSERT
			INTO
				IDN_OAUTH2_ACCESS_TOKEN_SYNC(TOKEN_ID)
...
CREATE
	TRIGGER IDN_OAUTH2_ACCESS_TOKEN_SCOPE_SYNC_INSERT_TRIGR BEFORE INSERT
		ON
...
CREATE
	TRIGGER IDN_OAUTH2_ACCESS_TOKEN_SCOPE_SYNC_UPDATE_TRIGR BEFORE UPDATE
		ON
		IDN_OAUTH2_ACCESS_TOKEN_SCOPE FOR EACH ROW BEGIN INSERT
			INTO
				IDN_OAUTH2_ACCESS_TOKEN_SCOPE_SYNC(TOKEN_ID)
...
CREATE
	TRIGGER IDN_OAUTH2_AUTHORIZATION_CODE_SYNC_INSERT_TRIGR BEFORE INSERT
		ON
...
CREATE
	TRIGGER IDN_OAUTH2_AUTHORIZATION_CODE_SYNC_UPDATE_TRIGR BEFORE UPDATE
		ON
		IDN_OAUTH2_AUTHORIZATION_CODE FOR EACH ROW BEGIN INSERT
			INTO
				IDN_OAUTH2_AUTHORIZATION_CODE_SYNC(TOKEN_ID)
